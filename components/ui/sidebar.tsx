  ...
  (
    ...
    const setOpen = React.useCallback(
      (value: boolean | ((value: boolean) => boolean)) => {
        ...
        // biome-ignore lint/suspicious/noDocumentCookie: shadcn persiste el estado del sidebar vía cookie
...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    <Button
      ...
      variant="ghost"
      size="icon"
      className={cn("h-7 w-7 cursor-pointer hover:bg-accent", className)}
      onClick={(event) => {
        onClick?.(event);
        toggleSidebar();
      }}
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ...
      data-sidebar="group"
      className={cn(
        "relative gap-1 flex w-full min-w-0 flex-col p-2",
        className,
      )}
      {...props}
    />
